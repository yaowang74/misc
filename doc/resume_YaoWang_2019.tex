...
\begin{itemize}
	...
	\item{\cventry{March 2019--Present}{Senior Data Scientist}{NEC Labs America}{Princetons, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				\item \emph{Lockheed Martin} Space Tech Ops
				\item D2D event recognition, failure prediction
				\item EVT on solar storm, space weather
			\end{itemize}}}
