...
\begin{itemize}
	...
	\item{\cventry{October 2017--Present}{Senior Data Scientist}{Honeywell International Inc.}{Morris Plains, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				\item \emph{FreshDirect} equips with Honeywell's most advanced IoT conveyor belt system and warehouse excution system(WES)
				...
				\item \emph{FreshDirect} daily tote throughput increased from about 7000 to approximately 15000 when project was completed
			\end{itemize}}}
