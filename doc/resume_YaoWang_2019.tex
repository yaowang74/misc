...
\usepackage[scale=0.75]{geometry}                  % \usepackage[scale=0.8,top=2cm]{geometry}
...
\makecvtitle
\vspace*{-8mm}
\small{7+ years research and industrial experience in data science and machine learning, a well-trained scientist in mathematical optimization and algorithm development, passionate presenter with extensive knowledge in numerical methods for solving large scale statistical learning problems.}
