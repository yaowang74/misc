...
\begin{itemize}
	...
	\item{\cventry{March 2019--Present}{Senior Data Scientist}{NEC Laboratories America Inc.}{Princetons, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				\item \emph{Lockheed Martin} LSTM autoencoder based product for statellite anomally detection with telemetry data
				\item \emph{Sikorsky} System invariant method for knowledge learning, transfer learning, anomally detection and real-time monitoring
				\item Human activity recognition through optical sensing data, wavelet transform and 1D convolution neural netowrk based solution
				\item Reinforment learning and its application in multivariate categorical time series analysis, sequence of events and log analysis
			\end{itemize}}}
	...
	\item{\cventry{October 2017--Present}{Senior Data Scientist}{Honeywell International Inc.}{Morris Plains, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				...
				\item Led a team of data scientists and engineers, designed and built entire pipeline with \textbf{Python} for insight analysis that contains four major modules: data loader(SQL library), feature engine(parallel massive data transformation), gpu accelarated(\textbf{Azure NC12 v2}) gradient boosting tree training and visualization module for key KPIs
	...
	\item{\cventry{October 2016--September 2017}{Data Scientist}{Honeywell International Inc.}{Morris Plains, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				...
				\item Led data engineers in India to clean and ingest over 1T raw smart meter data into \textbf{Hive} (\textbf{Azure} backended)
