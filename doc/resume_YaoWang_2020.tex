...
\begin{itemize}
	...
	\item{\cventry{March 2019--Present}{Senior Associate Researcher}{NEC Laboratories America Inc.}{Princetons, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				\item \emph{Lockheed Martin - Space:} Deep temporal point process and its applications in system events modeling, categorical time series anlysis and log analysis.
