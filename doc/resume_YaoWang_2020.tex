...
%\address{2432 West Broadway}{Vancouver}{BC}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\begin{itemize}
	...
	\item{\cventry{March 2019--August 2020}{Senior Data Scientist}{NEC Laboratories America Inc.}{Princetons, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
	...
	\item{\cventry{October 2016--March 2019}{Senior Data Scientist}{Honeywell International Inc.}{Morris Plains, NJ}{}
		{\vspace{3pt}
			\begin{itemize}
				...
				%\item Identified one crucial issue that causes orders congestion and conveyor belt unbalanced workload 
				...
				%gpu accelerated(\textbf{Azure NC12 v2}) gradient boosting tree training and visualization module for key KPIs
...
%				\item Learned data science(PK/PD) models in pharmacometrics and web development techniques using  \textbf{Apache} web server, \textbf{MySQL}, \textbf{Python}, \textbf{R}, \textbf{Javascript} and \textbf{HTML5} %Greatly reduced the overhead of communication between clinicians and  pharmacometricians					
...
%				\item Analyzed and visualized complex data from USCG, finalized the optimal boat-sharing integer programming model %that generates various schemes with different parameters
				...
				\item I provided the best boat-sharing plan for USCG to cover required mission hours under tight budget by solving the model with \textbf{Xpress-Mosel}, and presented the analysis and delivered the product to USCG leaders %monthly and drafted the guidance on the project. 
			\end{itemize}}}
