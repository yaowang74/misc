...
\section{SUMMARY}
\textbf{7+} years experience in data science and machine learning, a well-trained scientist in mathematical optimization and algorithm development, passionate presenter with extensive knowledge in numerical methods for solving large scale statistical learning problems. %Highly analytical, focused and personable, with broad interests in quantitative research, technology and consulting
...
\section{WORK EXPERIENCE} \parskip 11 pt
	\textbf{Honeywell} ~~\textbf{Senior Data Scientist, ~~ Honeywell Industrial Analytics}\hfill Oct. 2017 - Present
		\begin{itemize}
            \item spark and H2O training
            \item interview data scientists candidate
