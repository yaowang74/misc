...
%			\item Programmed the effective plotting interface for understanding and interpreting modeling work
			...
			\item Implemented a web service using \textbf{Linux}, \textbf{Apache} web server, along with \textbf{MySQL}, \textbf{Python} and \textbf{R} for server-side, \textbf{Javascript} and \textbf{HTML5} for client-side programming %Greatly reduced the overhead of communication between clinicians and  pharmacometricians					
