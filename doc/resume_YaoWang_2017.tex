...
\section{RESEARCH} \parskip 11pt
	...
	\begin{itemize}\itemsep -1pt
		...
		\item Implemented new engine for common optimization problems with Matlab and C++, wrote a library including \textbf{conjugate gradient, L-BFGS and steepest decent} methods as sub-solvers
		\item Overall computing overhead is reduced by 30\% compared with classical frameworks
	\end{itemize}
%
\section{WORK EXPERIENCE} \parskip 11pt
	\textbf{Honeywell} \qquad\qquad\qquad\textbf{Data Scientist, COE}\hfill Oct. 2016 - Present
		\begin{itemize}
			\item a
			\item b
			\item c
			\item d
		\end{itemize}
	\textbf{Chubb Corporation}\qquad \textbf{Actuarial Modeler, Advanced Analytics}\hfill May 2015 - Oct. 2016
		\begin{itemize}
			%\item Learned \textbf{JSON} and \textbf{Solr} and enhanced the text mining web application. Proficient in \textbf{Git} 
			\item Performed data engineering on $\sim$10 million rows of claims/medical data to create variables. Built \textbf{decision tree} severity model for 7-Eleven bodily injury claims at first contact and \textbf{logistic regression} model at 6 months evaluation point %Compared to subjective classification that is used in practice, new models leads to significant improvements in the prediction of severity level and insurer's reserves 
			...
			\item  Carried out the underwriters social network analysis with \textbf{R} and \textbf{iGraph} to identify the key features that differentiate successful performers. 
			\item Established the \textbf{SVM} network-revenue model %and provided actionable solutions 
			to help underwriters create more revenue by a margin of 10\% % improving their professional network structure
		...
		\end{itemize}
	\textbf{Novartis Pharmaceuticals}\qquad\qquad\qquad \textbf{Quantitative Science Intern}    \hfill May - Aug. 2014
		\begin{itemize}\itemsep -1pt
...
%			\item Programmed the effective plotting interface for understanding and interpreting modeling work
		...
		\end{itemize}
    \textbf{Eli Lilly and Company}\qquad\qquad \textbf{Data Visualization Intern  %Manufacturing Technology
    }\hfill May - Aug. 2012, Jul. - Dec. 2013
        \begin{itemize}\itemsep -1pt
            ...
            \item  Automated the visualization tool to be database driven thereby eliminating maintenance overhead %for five filtration experiments
...
%           \item Fully utilized the advanced equipment by providing programming support and hence greatly reduced the cost of human resources
            \item Developed a data acquisition application to interface with the advanced \textbf{IoT} equipment costing over \$200K %and hence greatly reduced the cost of human resources and created manuals for both data visualization and acquisition applications to aid users and developers
    ...
    DHS-Rutgers COE}\qquad\qquad\qquad\textbf{Advanced Analytics Researcher}  \hfill Jan.-Jun. 2013
        \begin{itemize}\itemsep -1pt
            \item Captured and analyzed complex information given by U.S. Coast Guard to establish the optimal boat-allocation model with \textbf{Xpress-Mosel}%that generates various schemes with different parameters
            %\item Presented the briefings to upper management monthly and drafted the guidance on the project
            \item Recommended the best boat-sharing plan for U.S. Coast Guard to cover required mission hours under tight budget and presented the analysis to C-level management %monthly and drafted the guidance on the project. 
        \end{itemize}
